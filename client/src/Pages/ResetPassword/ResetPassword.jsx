...
function PasswordResetProcess() {
    ...
    const verifyToken = async () => {
        try { 
            const response = await axios.get(`http://localhost:7000/v1/customers/password/reset/verify/${token}`);
    ...
    const handleResetPassword = async () => {
        try {
            ...
            if (isValidToken) {
                ...
                const response = await axios.post(`http://localhost:7000/v1/customers/password/reset/update/${token}`, {
