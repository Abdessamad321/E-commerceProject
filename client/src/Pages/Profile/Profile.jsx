    ...
    <div className="edit-profile">
      <div style={{
        ...
        {customer.customer_image ? (
          <img
            src={customer.customer_image instanceof File ? URL.createObjectURL(customer.customer_image) : (customer.customer_image)}
            alt=""
            style={{
              width: '100%',
              height: '100%',
      ...
      <div className="inputs">
        ...
        <input
          ...
          onChange={(e) => setCustomer({ ...customer, new_password: e.target.value })}
        />
      </div>
      <div className="inputs">
        <label>Email</label>
